...
const translations = {
  ...
  ta: {
    ...
    names_bride: "aKdh",
    date: "மே 29, 2026",
    hero_subtitle: "எங்கள் திருமண விழாவிற்கு உங்களை அன்புடன் வரவேற்கிறோம்",
    scroll: "கீழே செல்லவும்",
    details_title: "tptuq;fs;",
    details_subtitle: "எங்கள் வாழ்க்கையின் மிக முக்கியமான நாளை உங்களுடன் கொண்டாட ஆவலாக காத்திருக்கிறோம்.\n எங்கள் திருமணத்திற்கான அனைத்து விவரங்களும் இங்கே.",
    when_wedding: "jpUkzk;",
    ...
    navigate: "Google Maps-ல் திறக்க",
