  ...
  return (
    <section className="py-24 md:py-32 bg-stone-50 text-stone-800">
      <div className="container mx-auto px-4 max-w-5xl">
        ...
        >
          <h2
            className={`text-5xl md:text-5xl text-primary mb-6 ${lang === "ta" ? "font-bamini-34 md:text-6xl" : "font-serif"}`}
          >
            {t("details_title")}
          </h2>
          <p
            className={`max-w-2xl mx-auto text-stone-600 leading-relaxed text-lg ${lang === "ta" ? "text-xs md:text-xl" : "font-serif"}`}
          >
            {t("details_subtitle")
              .split("\n")
              .map((line, i) => (
        ...
        >
          <h3
            className={`text-2xl mb-6 text-stone-800 ${lang === "ta" ? "text-xl font-semibold" : "font-serif"}`}
          >
            {t("navigate")}
          </h3>
          ...
          <a
            ...
            rel="noreferrer"
            onClick={() =>
              trackEvent("button_click", { buttonId: "navigate_map" })
            }
...
function DetailCard({
  ...
  return (
    ...
    >
      ...
      <h3
        className={`mb-4 text-stone-800 ${lang === "ta" ? "font-bamini-34 text-4xl" : "font-serif text-2xl"}`}
      >
        {title}
      </h3>
